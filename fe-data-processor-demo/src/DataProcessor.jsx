...
import { FileUp, CheckLine, Download, Loader2, RotateCcw, ChevronDown, Moon, Info } from 'lucide-react';
...
export default function DataProcessor() {
  const options = [
    { value: 'bulk_metrics_1', label: 'Bulk Metrics 1' },
    { value: 'bulk_metrics_2', label: 'Bulk Metrics 2' },
    { value: 'bulk_metrics_3', label: 'Bulk Metrics 3' },
  ];
    ...
    <div className={`min-h-screen px-4 py-4 sm:px-6 md:px-8 md:py-10 lg:py-12 flex items-center justify-center
      ...
      <div className={`max-w-6xl w-full mx-auto px-10 py-10 rounded-3xl shadow-md border-2 
        ...
        <div className='flex items-center justify-center gap-2 mb-6'>
          <h1 className={`text-[clamp(1.3rem,_5vw,_2rem)] font-bold ${dark ? 'text-themeColors-dark-text-default' : 'text-themeColors-light-text-default'}`}>
            Data Processor (Demo)
          </h1>
          <Info
          data-tooltip-id="demo-tooltip" 
          data-tooltip-content="The result file is dummy data, generated for demo purposes only"
          className={`w-3 h-3 md:w-4 md:h-4 lg:w-5 lg:h-5 ${dark ? 'text-themeColors-dark-primary' : 'text-themeColors-light-primary'}`}/>
        ...
        <div className="mb-5">
          ...
          <h2 className={`text-[clamp(1.1rem,_4vw,_1.5rem)] font-bold mb-1 ${dark ? 'text-themeColors-dark-text-default' : 'text-themeColors-light-text-default'}`}>
            Select Code
          </h2>
        ...
        <div className="mb-5">
          <div className="flex items-center gap-2">
            ...
            <p className={`text-[clamp(0.3rem,_3vw,_0.9rem)] mb-1 ${dark ? 'text-themeColors-dark-text-default' : 'text-themeColors-light-text-default'}`}>
              <span className="text-red-600">* </span>Select any CSV File
            </p>
          </div>
          ...
          <div 
            ...
            ${
              isDragging
                ? dark
                  ? 'border-themeColors-dark-primary bg-themeColors-dark-boxColumn-default drag-active'
                  : 'border-themeColors-light-primary bg-themeColors-light-secondary drag-active'
                : isLoading
                ? dark
                  ? 'opacity-60 pointer-events-none bg-themeColors-dark-boxColumn-default border-themeColors-dark-border'
                  : 'opacity-60 pointer-events-none bg-themeColors-light-boxColumn-muted border-themeColors-light-border'
                : dark
                ? 'border-themeColors-dark-border bg-themeColors-dark-boxColumn-default hover:border-themeColors-dark-primary'
                : 'border-themeColors-light-border bg-themeColors-light-boxColumn-default hover:border-themeColors-light-primary hover:bg-themeColors-light-secondary'
            }
            `}
            onDrop={handleDrop}
